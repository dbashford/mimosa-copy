...
exports.defaults = function() {
  return {
    copy: {
      extensions: ["aff","dic","js","css","png","jpg","jpeg","gif","html","php","eot","svg","ttf","woff","woff2","otf","yaml","kml","ico","htc","htm","json","txt","xml","xsd","map","md","mp4","mp3","swf","apng","mng","phtml","volt","gz"],
      exclude: []
    }
  };
};
